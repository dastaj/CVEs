...
However, depending on code of your application, the attacker can gain access to all data within application, what can make with vulnerability more critical.
